        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
            ...
            <ul className="space-y-2 text-sm text-blue-800">
              <li>• <strong>عمولة الإيداع:</strong> 10% من كل عملية إيداع للعملاء</li>
              <li>• <strong>عمولة السحب:</strong> 10% من كل عملية سحب للمستقلين</li>
              <li>• <strong>عمولة المشروع:</strong> 20% إجمالي (10% من العميل + 10% من المستقل)</li>
